...
export async function PromptingStepBack(prompt) {
  try {
    const AIprompt = `
        ...
        question. when you are askeed a question think about the background of the question
        first identify the basis of that question and then convert that question to better version with all background.
        example question:-
        ...
        there can other questions also
